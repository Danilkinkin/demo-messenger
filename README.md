# Это моя реализация тестового задания для устройства на работу в МегаФон

> :warning: **Не используйте это решениие**: Это моё решение задачи, и если вы попытайтесь выдать это решение за своё, это увидят
